...
cards.forEach((card) => {
  card.addEventListener("mousemove", (e) => {
    ...
    let x = (e.clientX / 1.5 - rect.left) / 10; // x position within the element.
    let y = (e.clientY / 2.5 - rect.top) / 10; // y position within the element.
...
// Add scroll event listeners for each card
cards.forEach((card) => {
